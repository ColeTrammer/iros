...
namespace iris {
class RecursiveSpinlock : di::util::Immovable {
public:
    ...
    bool try_lock() {
        ...
        // FIXME: check if the locker for this Spinlock is the currently executing processor when using SMP.
        m_state.exchange(true, di::sync::MemoryOrder::Acquire);
