...
#define GS_PROCESSOR_OFFSET   3UL
#define USER_CODE_OFFSET      4UL
#define USER_DATA_OFFSET      5UL
#define GS_USER_THREAD_OFFSET 6UL
#define GDT_TSS_OFFSET        7UL

#define CS_SELECTOR             (CS_OFFSET * 8UL)
#define DATA_SELECTOR           (DATA_OFFSET * 8UL)
#define GS_PROCESSOR_SELECTOR   (GS_PROCESSOR_OFFSET * 8UL)
#define USER_CODE_SELECTOR      ((USER_CODE_OFFSET * 8UL) | 0b11)
#define USER_DATA_SELECTOR      ((USER_DATA_OFFSET * 8UL) | 0b11)
#define GS_USER_THREAD_SELECTOR ((GS_USER_THREAD_OFFSET * 8UL) | 0b11)
