...
static struct inode_operations dev_i_op = { NULL, &dev_lookup, &dev_open, &dev_stat, &dev_ioctl, NULL,
                                            NULL, NULL,        NULL,      &dev_mmap, NULL,       NULL };

static struct inode_operations dev_dir_i_op = { NULL, &dev_lookup, &dev_open, &dev_stat, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL };
