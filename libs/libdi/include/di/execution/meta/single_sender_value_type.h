...
namespace detail {
    ...
    using SingleSenderValueTypeHelper =
        meta::Type<meta::Conditional<sizeof...(Types) == 0, meta::Id<void>,
...
requires(concepts::Sender<Send, Env> &&
         !concepts::SameAs<detail::SingleSenderValueTypeHelperBadValue,
                           ValueTypesOf<Send, Env, detail::SingleSenderValueTypeHelper, detail::SingleSenderValueTypeHelper>>)
using SingleSenderValueType = ValueTypesOf<Send, Env, detail::SingleSenderValueTypeHelper, detail::SingleSenderValueTypeHelper>;
}