...
#define DI_ASSERT(...) \
    di::assert::detail::do_assert<di::container::FixedString { "" #__VA_ARGS__ }>(bool(__VA_ARGS__), di::util::SourceLocation::current())
...
#define DI_ASSERT_LT(a, b)                                                                                            \
    di::assert::detail::do_binary_assert<di::container::FixedString { "" #a " < " #b }>(di::function::less, (a), (b), \
                                                                                        di::util::SourceLocation::current())
