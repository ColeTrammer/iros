...
namespace detail {
    struct FindLastNotOfFunction {
        ...
        constexpr View<It> operator()(It it, Sent sent, Jt jt, Jent jent, Pred pred = {}, Proj proj = {}, Jroj jroj = {}) const {
        ...
        constexpr meta::BorrowedView<Con> operator()(Con&& container, Needles&& needles, Pred pred = {}, Proj1 proj1 = {},
                                                     Proj2 proj2 = {}) const {
