...
namespace detail {
    struct FindEndFunction {
        template<concepts::ForwardIterator It, concepts::SentinelFor<It> Sent, concepts::ForwardIterator Jt, concepts::SentinelFor<Jt> Jent,
        ...
        constexpr View<It> operator()(It it, Sent ed, Jt jt, Jent fd, Pred pred = {}, Proj proj = {}, Jroj jroj = {}) const {
            if (jt == fd) {
        ...
        constexpr meta::BorrowedView<Con> operator()(Con&& con, Jon&& jon, Pred pred = {}, Proj proj = {}, Jroj jroj = {}) const {
