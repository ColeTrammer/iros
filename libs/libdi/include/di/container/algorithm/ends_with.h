...
namespace detail {
    struct EndsWithFunction {
        ...
        constexpr bool operator()(It it, Sent ed, Jt jt, Jent fd, Pred pred = {}, Proj proj = {}, Jroj jroj = {}) const {
            ...
            return container::equal(util::move(it), ed, util::move(jt), fd, util::ref(pred), util::ref(proj), util::ref(jroj));
        }
        ...
        requires((concepts::ForwardContainer<Con> || concepts::SizedContainer<Con>) &&
                 ...
                 concepts::IndirectlyComparable<meta::ContainerIterator<Con>, meta::ContainerIterator<Don>, Pred, Proj, Jroj>)
        constexpr bool operator()(Con&& a, Don&& b, Pred pred = {}, Proj proj = {}, Jroj jroj = {}) const {
            return (*this)(container::begin(a), container::end(a), container::begin(b), container::end(b), util::ref(pred), util::ref(proj),
                           util::ref(jroj));
        }
    };
}
