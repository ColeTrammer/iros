...
namespace detail {
    struct TransformFunction {
        ...
        constexpr InOutResult<meta::BorrowedIterator<Con>, Out> operator()(Con&& container, Out output, F op, Proj proj = {}) const {
            return (*this)(container::begin(container), container::end(container), util::move(output), util::ref(op), util::ref(proj));
        }
        ...
        constexpr InInOutResult<It1, It2, Out> operator()(It1 first1, Sent1 last1, It2 first2, Sent2 last2, Out output, F op,
        ...
        template<concepts::InputContainer Con1, concepts::InputContainer Con2, concepts::WeaklyIncrementable Out,
                 concepts::CopyConstructible F, typename Proj1 = function::Identity, typename Proj2 = function::Identity>
        requires(concepts::IndirectlyWritable<Out, meta::IndirectResult<F&, meta::Projected<meta::ContainerIterator<Con1>, Proj1>,
                                                                        meta::Projected<meta::ContainerIterator<Con2>, Proj2>>>)
        constexpr InInOutResult<meta::BorrowedIterator<Con1>, meta::BorrowedIterator<Con2>, Out> transform(Con1&& r1, Con2&& r2, Out output,
                                                                                                           F op, Proj1 proj1 = {},
                                                                                                           Proj2 proj2 = {}) {
            return (*this)(container::begin(r1), container::end(r1), container::begin(r2), container::end(r2), util::move(output),
                           util::ref(op), util::ref(proj1), util::ref(proj2));
        }
    };
}
