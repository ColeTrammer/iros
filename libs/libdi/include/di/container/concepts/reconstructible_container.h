...
concept ReconstructibleContainer = requires(
    It iterator, Sent sentinel) { container::reconstruct(in_place_type<Con>, util::forward<It>(iterator), util::forward<Sent>(sentinel)); };
}