...
concept IndirectlyMovableStorable =
    IndirectlyMovable<In, Out> && IndirectlyWritable<Out, meta::IteratorValue<In>> && Movable<meta::IteratorValue<In>> &&
    ConstructibleFrom<meta::IteratorValue<In>, meta::IteratorRValue<In>> &&
