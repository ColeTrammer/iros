...
class ZipView
    ...
    , public meta::EnableBorrowedContainer<ZipView<Views...>, concepts::Conjunction<concepts::BorrowedContainer<Views>...>> {
private:
    ...
    constexpr static bool all_sized = concepts::Conjunction<concepts::SizedContainer<meta::MaybeConst<is_const, Views>>...>;

    template<bool is_const>
    constexpr static bool all_forward = concepts::Conjunction<concepts::ForwardContainer<meta::MaybeConst<is_const, Views>>...>;

    template<bool is_const>
    constexpr static bool all_bidirectional = concepts::Conjunction<concepts::BidirectionalContainer<meta::MaybeConst<is_const, Views>>...>;

    template<bool is_const>
    constexpr static bool all_random_access = concepts::Conjunction<concepts::RandomAccessContainer<meta::MaybeConst<is_const, Views>>...>;

    template<bool is_const>
    constexpr static bool all_common = concepts::Conjunction<concepts::CommonContainer<meta::MaybeConst<is_const, Views>>...>;
    ...
    public:
        ...
        requires(is_const && concepts::Conjunction<concepts::ConvertibleTo<meta::ContainerIterator<Views>,
    ...
    private:
        ...
        requires(all_random_access<is_const> &&
                 concepts::Conjunction<concepts::ThreeWayComparable<meta::ContainerIterator<meta::MaybeConst<is_const, Views>>>...>)
        {
            return a.m_iterators <=> b.m_iterators;
        }

        constexpr friend SSizeType<is_const> operator-(Iterator const& a, Iterator const& b)
        requires(concepts::Conjunction<concepts::SizedSentinelFor<meta::ContainerIterator<meta::MaybeConst<is_const, Views>>,
                                                                  meta::ContainerIterator<meta::MaybeConst<is_const, Views>>>...>)
        {
            return function::unpack<meta::MakeIndexSequence<sizeof...(Views)>>([&]<size_t... indices>(meta::IndexSequence<indices...>) {
                return container::min(
                    { static_cast<SSizeType<is_const>>(util::get<indices>(a.m_iterators) - util::get<indices>(b.m_iterators))... });
            });
        }
        ...
        requires(concepts::Conjunction<concepts::IndirectlySwappable<meta::ContainerIterator<meta::MaybeConst<is_const, Views>>,
                                                                     meta::ContainerIterator<meta::MaybeConst<is_const, Views>>>...>)
        {
            return function::unpack<meta::MakeIndexSequence<sizeof...(Views)>>([&]<size_t... indices>(meta::IndexSequence<indices...>) {
    ...
    public:
        ...
        requires(is_const && concepts::Conjunction<concepts::ConvertibleTo<meta::ContainerSentinel<Views>,
                                                                           meta::ContainerSentinel<meta::MaybeConst<is_const, Views>>>...>)
            : m_sentinels(util::move(other)) {}

        template<bool other_is_const>
        requires(concepts::Conjunction<concepts::SizedSentinelFor<meta::ContainerSentinel<meta::MaybeConst<is_const, Views>>,
        ...
        constexpr auto difference(Iterator<other_is_const> const& a) const {
            return function::unpack<meta::MakeIndexSequence<sizeof...(Views)>>([&]<size_t... indices>(meta::IndexSequence<indices...>) {
                return container::min(
                    { static_cast<SSizeType<is_const>>(util::get<indices>(this->m_sentinels) - util::get<indices>(a.m_iterators))... });
            });
        }

    private:
        template<bool other_is_const>
        requires(concepts::Conjunction<concepts::SentinelFor<meta::ContainerSentinel<meta::MaybeConst<is_const, Views>>,
                                                             meta::ContainerIterator<meta::MaybeConst<other_is_const, Views>>>...>)
