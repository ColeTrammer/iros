...
struct FormatterInPlaceFunction {
    ...
    requires(concepts::TagInvocable<FormatterInPlaceFunction, InPlaceType<T>, FormatParseContext<Enc>&>)
    constexpr auto operator()(InPlaceType<T>, FormatParseContext<Enc>& context) const {
...
template<typename T, concepts::Encoding Enc>
constexpr auto formatter(FormatParseContext<Enc>& parse_context)
