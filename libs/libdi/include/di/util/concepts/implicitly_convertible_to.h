...
#include <di/util/concepts/language_void.h>
...
concept ImplicitlyConvertibleTo = (LanguageVoid<From> && LanguageVoid<To>) || requires(void (*function_accepting_to)(To), From&& from) {
