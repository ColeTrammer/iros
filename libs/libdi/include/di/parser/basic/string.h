...
namespace detail {
    ...
    constexpr auto tag_invoke(types::Tag<create_parser_in_place>, InPlaceType<container::string::StringViewImpl<Enc>>, Context&) {
        return match_zero_or_more([](auto) {
                   ...
                   [](Context& context, auto results) -> meta::ParserContextResult<container::string::StringViewImpl<Enc>, Context> {
    ...
    constexpr auto tag_invoke(types::Tag<create_parser_in_place>, InPlaceType<container::PathViewImpl<Enc>>, Context&) {
        return match_zero_or_more([](auto) {
                   ...
                   [](Context& context, auto results) -> meta::ParserContextResult<container::PathViewImpl<Enc>, Context> {
            auto encoding = context.encoding();
            auto begin = encoding::unicode_code_point_unwrap(encoding, results.begin());
            auto end = encoding::unicode_code_point_unwrap(encoding, results.end());
