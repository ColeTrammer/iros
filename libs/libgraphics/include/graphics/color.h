...
public:
    ...
    Color(uint8_t r, uint8_t b, uint8_t g, uint8_t a = 0x00) : m_color(a << 24 | r << 16 | g << 8 | b) {}
    ...
    void set(uint8_t r, uint8_t b, uint8_t g, uint8_t a = 0x00) { m_color = a << 24 | r << 16 | g << 8 | b; }
