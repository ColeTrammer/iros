...
constexpr auto tag_invoke(di::Tag<di::reflect>, di::InPlaceType<Key>) {
    ...
    return di::make_enumerators<"Key">(
        ...
        di::enumerator<"Up", Up>, di::enumerator<"Down", Down>, di::enumerator<"PageUp", PageUp>,
        di::enumerator<"PageDown", PageDown>, di::enumerator<"Home", Home>, di::enumerator<"End", End>,
        di::enumerator<"CapsLock", CapsLock>, di::enumerator<"ScrollLock", ScrollLock>,
        di::enumerator<"NumLock", NumLock>, di::enumerator<"PrintScreen", PrintScreen>, di::enumerator<"Pause", Pause>,
        di::enumerator<"Menu", Menu>, di::enumerator<"F1", F1>, di::enumerator<"F2", F2>, di::enumerator<"F3", F3>,
        di::enumerator<"F4", F4>, di::enumerator<"F5", F5>, di::enumerator<"F6", F6>, di::enumerator<"F7", F7>,
        di::enumerator<"F8", F8>, di::enumerator<"F9", F9>, di::enumerator<"F10", F10>, di::enumerator<"F11", F11>,
        di::enumerator<"F12", F12>, di::enumerator<"F13", F13>, di::enumerator<"F14", F14>, di::enumerator<"F15", F15>,
        di::enumerator<"F16", F16>, di::enumerator<"F17", F17>, di::enumerator<"F18", F18>, di::enumerator<"F19", F19>,
        di::enumerator<"F20", F20>, di::enumerator<"F21", F21>, di::enumerator<"F22", F22>, di::enumerator<"F23", F23>,
        di::enumerator<"F24", F24>, di::enumerator<"F25", F25>, di::enumerator<"F26", F26>, di::enumerator<"F27", F27>,
        di::enumerator<"F28", F28>, di::enumerator<"F29", F29>, di::enumerator<"F30", F30>, di::enumerator<"F31", F31>,
        di::enumerator<"F32", F32>, di::enumerator<"F33", F33>, di::enumerator<"F34", F34>, di::enumerator<"F35", F35>,
