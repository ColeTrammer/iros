...
template<> struct Traits<bool> {
    ...
    static unsigned int hash(const bool& obj) {
...
template<> struct Traits<uint8_t> {
    ...
    static unsigned int hash(const uint8_t& obj) {
        return static_cast<unsigned int>(obj);
    };
};
...
template<> struct Traits<uint16_t> {
    ...
    static unsigned int hash(const uint16_t& obj) {
        return static_cast<unsigned int>(obj);
    };
};
...
template<> struct Traits<uint32_t> {
    ...
    static unsigned int hash(const uint32_t& obj) {
        return static_cast<unsigned int>(obj);
    };
};
...
template<> struct Traits<uint64_t> {
    ...
    static unsigned int hash(const uint64_t& obj) {
...
template<> struct Traits<char> {
    ...
    static unsigned int hash(const int8_t& obj) {
        return static_cast<unsigned int>(obj);
    };
};
...
template<> struct Traits<int16_t> {
    ...
    static unsigned int hash(const int16_t& obj) {
        return static_cast<unsigned int>(obj);
    };
};
...
template<> struct Traits<int32_t> {
    ...
    static unsigned int hash(const int32_t& obj) {
        return static_cast<unsigned int>(obj);
    };
};
...
template<> struct Traits<int64_t> {
    ...
    static unsigned int hash(const int64_t& obj) {
        return static_cast<unsigned int>(obj) + static_cast<unsigned int>(obj >> 32);
    };
};
