...
namespace detail {
    struct SetSymmetricDifferenceFunction {
        ...
        constexpr auto operator()(It1 first1, Sent1 last1, It2 first2, Sent2 last2, Out out, Comp comp = {},
                                  Proj1 proj1 = {}, Proj2 proj2 = {}) const -> InInOutResult<It1, It2, Out> {
            // While both ranges are non-empty, compare some element is present in both ranges.
