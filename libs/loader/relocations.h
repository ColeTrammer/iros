...
int do_process_relocations(const struct dynamic_elf_object *self) LOADER_PRIVATE;
int process_relocations(const struct dynamic_elf_object *self) LOADER_PRIVATE;
