...
int do_process_relocations(const struct dynamic_elf_object *self, bool bind_now) LOADER_PRIVATE;
int process_relocations(const struct dynamic_elf_object *self, bool bind_now) LOADER_PRIVATE;
