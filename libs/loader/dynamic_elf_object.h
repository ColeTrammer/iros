...
size_t rel_count(const struct dynamic_elf_object *self) LOADER_PRIVATE;
const ElfW(Rel) * rel_table(const struct dynamic_elf_object *self) LOADER_PRIVATE;
const ElfW(Rel) * rel_at(const struct dynamic_elf_object *self, size_t i) LOADER_PRIVATE;
